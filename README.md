...
| STAND: Self-Aware Precondition Induction for Interactive Task Learning | [`NJes6aeTem`](https://openreview.net/forum?id=NJes6aeTem) | 8 | 6/8 TOY-VERIFIED, 1 TOY-VERIFIED (ranking diverges), 1 BLOCKED | [`stand-NJes6aeTem/`](stand-NJes6aeTem/) | [HF Space](https://huggingface.co/spaces/nmaher/repro-stand-self-aware-precondition-induction-for-interactive-task-learning) |
| Ellipsoidal Time Series Forecasting | [`CoAHlJuMdh`](https://openreview.net/forum?id=CoAHlJuMdh) | 5 | 1 VERIFIED (complexity, analytic), 2 TOY-VERIFIED (ablations; nonstationary robustness, partial), 1 REFUTED @ toy scale (EPT, reversed in all 6 scenarios), 1 INCONCLUSIVE (geometric persistence, mechanism not reached) | [`ellipsoidal-tsf-CoAHlJuMdh/`](ellipsoidal-tsf-CoAHlJuMdh/) | [HF Space](https://huggingface.co/spaces/nmaher/repro-ellipsoidal-time-series-forecasting) |
| Finite-Width Neural Tangent Kernels from Feynman Diagrams | [`SOlPHMdSY3`](https://openreview.net/forum?id=SOlPHMdSY3) | 3/5 | 3 TOY-VERIFIED, 2 INCONCLUSIVE | [`ntk-feynman-diagrams-SOlPHMdSY3/`](ntk-feynman-diagrams-SOlPHMdSY3/) | [HF Space](https://huggingface.co/spaces/nmaher/repro-finite-width-neural-tangent-kernels-from-feynman-diagrams) |
