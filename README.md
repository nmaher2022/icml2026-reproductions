...
| Finite-Width Neural Tangent Kernels from Feynman Diagrams | [`SOlPHMdSY3`](https://openreview.net/forum?id=SOlPHMdSY3) | 5/5 | 5 TOY-VERIFIED | [`ntk-feynman-diagrams-SOlPHMdSY3/`](ntk-feynman-diagrams-SOlPHMdSY3/) | [HF Space](https://huggingface.co/spaces/nmaher/repro-finite-width-neural-tangent-kernels-from-feynman-diagrams) |
