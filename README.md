...
| From Muon to Gluon: Bridging Theory and Practice of LMO-based Optimizers for LLMs | [`IelAHU5MVz`](https://openreview.net/forum?id=IelAHU5MVz) | 6 | mixed (1 verified; 2/3/4 toy-verified; 5 refuted at toy scale; 6 refuted — claim-extraction error) | [`gluon-lmo-optimizers-IelAHU5MVz/`](gluon-lmo-optimizers-IelAHU5MVz/) | not yet published |
